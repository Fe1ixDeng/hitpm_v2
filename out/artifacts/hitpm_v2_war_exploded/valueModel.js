...
<bpmn2:definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:activiti="http://activiti.org/bpmn" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:omgdc="http://www.omg.org/spec/DD/20100524/DC" xmlns:omgdi="http://www.omg.org/spec/DD/20100524/DI" typeLanguage="http://www.w3.org/2001/XMLSchema" expressionLanguage="http://www.w3.org/1999/XPath" targetNamespace="http://www.activiti.org/test">
  <bpmn2:process id="my-process" isExecutable="true">
    ...
    <bpmn2:userTask id="ApplyRepair" name="ApplyRepair"></bpmn2:userTask>
    <bpmn2:userTask id="UserIdentification" name="UserIdentification"></bpmn2:userTask>
    <bpmn2:exclusiveGateway id="GatewayXorS1"></bpmn2:exclusiveGateway>
    <bpmn2:userTask id="IntelligentResponse" name="IntelligentResponse"></bpmn2:userTask>
    <bpmn2:userTask id="ManualInteraction" name="ManualInteraction"></bpmn2:userTask>
    <bpmn2:exclusiveGateway id="GatewayXorS2"></bpmn2:exclusiveGateway>
    <bpmn2:userTask id="ReleaseOrder" name="ReleaseOrder"></bpmn2:userTask>
    <bpmn2:userTask id="OrderAssignment" name="OrderAssignment"></bpmn2:userTask>
    <bpmn2:exclusiveGateway id="GatewayXorS3"></bpmn2:exclusiveGateway>
    <bpmn2:userTask id="Repair" name="Repair"></bpmn2:userTask>
    <bpmn2:userTask id="TestRepair" name="TestRepair"></bpmn2:userTask>
    <bpmn2:userTask id="RestartRepair" name="RestartRepair"></bpmn2:userTask>
    <bpmn2:exclusiveGateway id="GatewayXorS4"></bpmn2:exclusiveGateway>
    <bpmn2:userTask id="Success" name="Success"></bpmn2:userTask>
    <bpmn2:userTask id="Renew" name="Renew"></bpmn2:userTask>
    <bpmn2:userTask id="ServiceEvaluation" name="ServiceEvaluation"></bpmn2:userTask>
    <bpmn2:userTask id="Archive" name="Archive"></bpmn2:userTask>
    <bpmn2:sequenceFlow id="StartApplyRepair" sourceRef="Start" targetRef="ApplyRepair"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="ApplyRepairUserIdentification" sourceRef="ApplyRepair" targetRef="UserIdentification"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="UserIdentificationGatewayXorS1" sourceRef="UserIdentification" targetRef="GatewayXorS1"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS1GatewayXorS2" sourceRef="GatewayXorS1" targetRef="GatewayXorS2"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS1IntelligentResponse" sourceRef="GatewayXorS1" targetRef="IntelligentResponse"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="IntelligentResponseManualInteraction" sourceRef="IntelligentResponse" targetRef="ManualInteraction"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="ManualInteractionGatewayXorS2" sourceRef="ManualInteraction" targetRef="GatewayXorS2"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS2ServiceEvaluation" sourceRef="GatewayXorS2" targetRef="ServiceEvaluation"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS2ReleaseOrder" sourceRef="GatewayXorS2" targetRef="ReleaseOrder"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="ReleaseOrderOrderAssignment" sourceRef="ReleaseOrder" targetRef="OrderAssignment"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="OrderAssignmentRepair" sourceRef="OrderAssignment" targetRef="Repair"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS3GatewayXorS4" sourceRef="GatewayXorS3" targetRef="GatewayXorS4"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS3RestartRepair" sourceRef="GatewayXorS3" targetRef="RestartRepair"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="RepairTestRepair" sourceRef="Repair" targetRef="TestRepair"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="TestRepairGatewayXorS3" sourceRef="TestRepair" targetRef="GatewayXorS3"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="RestartRepairRepair" sourceRef="RestartRepair" targetRef="Repair"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS4Renew" sourceRef="GatewayXorS4" targetRef="Renew"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="GatewayXorS4Success" sourceRef="GatewayXorS4" targetRef="Success"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="SuccessServiceEvaluation" sourceRef="Success" targetRef="ServiceEvaluation"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="RenewServiceEvaluation" sourceRef="Renew" targetRef="ServiceEvaluation"></bpmn2:sequenceFlow>
    <bpmn2:sequenceFlow id="ServiceEvaluationArchive" sourceRef="ServiceEvaluation" targetRef="Archive"></bpmn2:sequenceFlow>
  ...
  <bpmndi:BPMNDiagram id="BPMNDiagram_my-process">
    <bpmndi:BPMNPlane bpmnElement="my-process" id="BPMNPlane_my-process">
      <bpmndi:BPMNShape bpmnElement="ManualInteraction" id="BPMNShape_ManualInteraction">
        <omgdc:Bounds height="60.0" width="100.0" x="620.0" y="180.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="Archive" id="BPMNShape_Archive">
        <omgdc:Bounds height="60.0" width="100.0" x="2000.0" y="104.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="ReleaseOrder" id="BPMNShape_ReleaseOrder">
        <omgdc:Bounds height="60.0" width="100.0" x="860.0" y="180.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="Start" id="BPMNShape_Start">
        <omgdc:Bounds height="30.0" width="30.0" x="0.0" y="139.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="OrderAssignment" id="BPMNShape_OrderAssignment">
        <omgdc:Bounds height="60.0" width="100.0" x="1010.0" y="185.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="ServiceEvaluation" id="BPMNShape_ServiceEvaluation">
        <omgdc:Bounds height="60.0" width="100.0" x="1850.0" y="102.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="Success" id="BPMNShape_Success">
        <omgdc:Bounds height="60.0" width="100.0" x="1700.0" y="100.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="GatewayXorS2" id="BPMNShape_GatewayXorS2">
        <omgdc:Bounds height="40.0" width="40.0" x="770.0" y="125.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="GatewayXorS3" id="BPMNShape_GatewayXorS3">
        <omgdc:Bounds height="40.0" width="40.0" x="1460.0" y="140.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape bpmnElement="RestartRepair" id="BPMNShape_RestartRepair">
        <omgdc:Bounds height="60.0" width="100.0" x="1550.0" y="250.0"></omgdc:Bounds>
      </bpmndi:BPMNShape>
      ...
      <bpmndi:BPMNEdge bpmnElement="OrderAssignmentRepair" id="BPMNEdge_OrderAssignmentRepair">
        ...
        <omgdi:waypoint x="1122.0" y="215.0"></omgdi:waypoint>
        <omgdi:waypoint x="1122.0" y="220.0"></omgdi:waypoint>
      ...
      <bpmndi:BPMNEdge bpmnElement="SuccessServiceEvaluation" id="BPMNEdge_SuccessServiceEvaluation">
        <omgdi:waypoint x="1800.0" y="130.0"></omgdi:waypoint>
        <omgdi:waypoint x="1812.0" y="130.0"></omgdi:waypoint>
        <omgdi:waypoint x="1812.0" y="132.0"></omgdi:waypoint>
        <omgdi:waypoint x="1850.0" y="132.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="StartApplyRepair" id="BPMNEdge_StartApplyRepair">
        <omgdi:waypoint x="30.0" y="154.0"></omgdi:waypoint>
        <omgdi:waypoint x="80.0" y="154.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="ManualInteractionGatewayXorS2" id="BPMNEdge_ManualInteractionGatewayXorS2">
        ...
        <omgdi:waypoint x="770.0" y="145.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS4Success" id="BPMNEdge_GatewayXorS4Success">
        <omgdi:waypoint x="1620.0" y="122.5"></omgdi:waypoint>
        <omgdi:waypoint x="1662.0" y="122.5"></omgdi:waypoint>
        <omgdi:waypoint x="1662.0" y="130.0"></omgdi:waypoint>
        <omgdi:waypoint x="1700.0" y="130.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS3GatewayXorS4" id="BPMNEdge_GatewayXorS3GatewayXorS4">
        <omgdi:waypoint x="1500.0" y="152.5"></omgdi:waypoint>
        <omgdi:waypoint x="1512.0" y="152.5"></omgdi:waypoint>
        <omgdi:waypoint x="1512.0" y="130.0"></omgdi:waypoint>
        <omgdi:waypoint x="1580.0" y="130.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS1GatewayXorS2" id="BPMNEdge_GatewayXorS1GatewayXorS2">
        <omgdi:waypoint x="420.0" y="140.5"></omgdi:waypoint>
        <omgdi:waypoint x="432.0" y="140.5"></omgdi:waypoint>
      ...
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS1IntelligentResponse" id="BPMNEdge_GatewayXorS1IntelligentResponse">
        <omgdi:waypoint x="420.0" y="155.5"></omgdi:waypoint>
        <omgdi:waypoint x="432.0" y="155.5"></omgdi:waypoint>
      ...
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS3RestartRepair" id="BPMNEdge_GatewayXorS3RestartRepair">
        <omgdi:waypoint x="1500.0" y="167.5"></omgdi:waypoint>
        <omgdi:waypoint x="1512.0" y="167.5"></omgdi:waypoint>
        <omgdi:waypoint x="1512.0" y="280.0"></omgdi:waypoint>
        <omgdi:waypoint x="1550.0" y="280.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="ArchiveEnd" id="BPMNEdge_ArchiveEnd">
        <omgdi:waypoint x="2100.0" y="134.0"></omgdi:waypoint>
        <omgdi:waypoint x="2150.0" y="134.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS4Renew" id="BPMNEdge_GatewayXorS4Renew">
        <omgdi:waypoint x="1620.0" y="137.5"></omgdi:waypoint>
        <omgdi:waypoint x="1662.0" y="137.5"></omgdi:waypoint>
        <omgdi:waypoint x="1662.0" y="290.0"></omgdi:waypoint>
        <omgdi:waypoint x="1700.0" y="290.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="UserIdentificationGatewayXorS1" id="BPMNEdge_UserIdentificationGatewayXorS1">
        ...
        <omgdi:waypoint x="342.0" y="152.0"></omgdi:waypoint>
        <omgdi:waypoint x="342.0" y="148.0"></omgdi:waypoint>
      ...
      <bpmndi:BPMNEdge bpmnElement="ReleaseOrderOrderAssignment" id="BPMNEdge_ReleaseOrderOrderAssignment">
        ...
        <omgdi:waypoint x="972.0" y="210.0"></omgdi:waypoint>
        <omgdi:waypoint x="972.0" y="215.0"></omgdi:waypoint>
        <omgdi:waypoint x="1010.0" y="215.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS2ServiceEvaluation" id="BPMNEdge_GatewayXorS2ServiceEvaluation">
        <omgdi:waypoint x="810.0" y="137.5"></omgdi:waypoint>
        <omgdi:waypoint x="822.0" y="137.5"></omgdi:waypoint>
        <omgdi:waypoint x="822.0" y="132.0"></omgdi:waypoint>
        <omgdi:waypoint x="1850.0" y="132.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="GatewayXorS2ReleaseOrder" id="BPMNEdge_GatewayXorS2ReleaseOrder">
        <omgdi:waypoint x="810.0" y="152.5"></omgdi:waypoint>
        <omgdi:waypoint x="822.0" y="152.5"></omgdi:waypoint>
      ...
      <bpmndi:BPMNEdge bpmnElement="RestartRepairRepair" id="BPMNEdge_RestartRepairRepair">
        <omgdi:waypoint x="1550.0" y="292.5"></omgdi:waypoint>
        <omgdi:waypoint x="1538.0" y="292.5"></omgdi:waypoint>
        <omgdi:waypoint x="1538.0" y="220.0"></omgdi:waypoint>
        <omgdi:waypoint x="1160.0" y="220.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="RepairTestRepair" id="BPMNEdge_RepairTestRepair">
        <omgdi:waypoint x="1260.0" y="207.5"></omgdi:waypoint>
        <omgdi:waypoint x="1272.0" y="207.5"></omgdi:waypoint>
        <omgdi:waypoint x="1272.0" y="160.0"></omgdi:waypoint>
        <omgdi:waypoint x="1310.0" y="160.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="TestRepairGatewayXorS3" id="BPMNEdge_TestRepairGatewayXorS3">
        <omgdi:waypoint x="1410.0" y="160.0"></omgdi:waypoint>
        <omgdi:waypoint x="1460.0" y="160.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="RenewServiceEvaluation" id="BPMNEdge_RenewServiceEvaluation">
        <omgdi:waypoint x="1800.0" y="290.0"></omgdi:waypoint>
        <omgdi:waypoint x="1812.0" y="290.0"></omgdi:waypoint>
        <omgdi:waypoint x="1812.0" y="132.0"></omgdi:waypoint>
        <omgdi:waypoint x="1850.0" y="132.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="ServiceEvaluationArchive" id="BPMNEdge_ServiceEvaluationArchive">
        <omgdi:waypoint x="1950.0" y="132.0"></omgdi:waypoint>
        <omgdi:waypoint x="1962.0" y="132.0"></omgdi:waypoint>
        <omgdi:waypoint x="1962.0" y="134.0"></omgdi:waypoint>
        <omgdi:waypoint x="2000.0" y="134.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNEdge bpmnElement="Archive2value" id="BPMNEdge_Archive2value">
        <omgdi:waypoint x="2050.0" y="164.0"></omgdi:waypoint>
        <omgdi:waypoint x="2050.0" y="264.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="ReleaseOrder2value" id="BPMNEdge_ReleaseOrder2value">
        ...
        <omgdi:waypoint x="910.0" y="340.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="OrderAssignment2value" id="BPMNEdge_OrderAssignment2value">
        <omgdi:waypoint x="1060.0" y="245.0"></omgdi:waypoint>
        <omgdi:waypoint x="1060.0" y="345.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="ServiceEvaluation2value" id="BPMNEdge_ServiceEvaluation2value">
        <omgdi:waypoint x="1900.0" y="162.0"></omgdi:waypoint>
        <omgdi:waypoint x="1900.0" y="262.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="Success2value" id="BPMNEdge_Success2value">
        <omgdi:waypoint x="1750.0" y="160.0"></omgdi:waypoint>
        <omgdi:waypoint x="1750.0" y="260.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge bpmnElement="RestartRepair2value" id="BPMNEdge_RestartRepair2value">
        <omgdi:waypoint x="1600.0" y="310.0"></omgdi:waypoint>
        <omgdi:waypoint x="1600.0" y="410.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNEdge bpmnElement="Renew2value" id="BPMNEdge_Renew2value">
        ...
        <omgdi:waypoint x="1750.0" y="420.0"></omgdi:waypoint>
      </bpmndi:BPMNEdge>
    </bpmndi:BPMNPlane>
  </bpmndi:BPMNDiagram>
</bpmn2:definitions>`