...
<head>
    ...
    <title>BPMNJS</title>
    <jsp:useBean id="ICES_beans_variantMap1" class="hitpm_v2.ICES_beans_variant.XMLtoJS" scope="session"/>
    <jsp:useBean id="ICES_beans_variantXML1" class="hitpm_v2.ICES_beans_variant.translator.testWriteXML" scope="session"/>
    <jsp:useBean id="ICES_beans_variantSource1" class="hitpm_v2.ICES_beans_variant.ShowVariant_String" scope="session"/>
...
<body>
<%
    ICES_beans_variantXML1.testWriteXML(ICES_beans_variantSource1.variantBack(out, ICES_beans_variant1.getLog(), ICES_beans_trace1.printTraceTable1(out,ICES_beans_trace1.getLog()), 1));
%>
<%
    ICES_beans_variantMap1.writeXML("out/artifacts/hitpm_v2_war_exploded/Model1.js");
%>
