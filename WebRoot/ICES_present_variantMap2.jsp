...
<head>
  ...
  <title>BPMNJS</title>
  <jsp:useBean id="ICES_beans_variantMap2" class="hitpm_v2.ICES_beans_variant.XMLtoJS" scope="session"/>
  <jsp:useBean id="ICES_beans_variantXML2" class="hitpm_v2.ICES_beans_variant.translator.testWriteXML" scope="session"/>
  <jsp:useBean id="ICES_beans_variantSource2" class="hitpm_v2.ICES_beans_variant.ShowVariant_String" scope="session"/>
...
<body>
<%
  ICES_beans_variantXML2.testWriteXML(ICES_beans_variantSource2.variantBack(out, ICES_beans_variant2.getLog(), ICES_beans_trace2.printTraceTable1(out,ICES_beans_trace2.getLog()), 2));
%>
<%
  ICES_beans_variantMap2.writeXML("out/artifacts/hitpm_v2_war_exploded/Model1.js");
%>
