...
<head>
    ...
    <title>BPMNJS</title>
    <jsp:useBean id="ICES_beans_variantMap3" class="hitpm_v2.ICES_beans_variant.XMLtoJS" scope="session"/>
    <jsp:useBean id="ICES_beans_variantXML3" class="hitpm_v2.ICES_beans_variant.translator.testWriteXML" scope="session"/>
    <jsp:useBean id="ICES_beans_variantSource3" class="hitpm_v2.ICES_beans_variant.ShowVariant_String" scope="session"/>
...
<body>
<%
    ICES_beans_variantXML3.testWriteXML(ICES_beans_variantSource3.variantBack(out, ICES_beans_variant3.getLog(), ICES_beans_trace3.printTraceTable1(out,ICES_beans_trace3.getLog()), 3));
%>
<%
    ICES_beans_variantMap3.writeXML("out/artifacts/hitpm_v2_war_exploded/Model1.js");
%>
