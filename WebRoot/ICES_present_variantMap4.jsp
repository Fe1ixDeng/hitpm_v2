...
<head>
    ...
    <title>BPMNJS</title>
    <jsp:useBean id="ICES_beans_variantMap4" class="hitpm_v2.ICES_beans_variant.XMLtoJS" scope="session"/>
    <jsp:useBean id="ICES_beans_variantXML4" class="hitpm_v2.ICES_beans_variant.translator.testWriteXML" scope="session"/>
    <jsp:useBean id="ICES_beans_variantSource4" class="hitpm_v2.ICES_beans_variant.ShowVariant_String" scope="session"/>
...
<body>
<%
    ICES_beans_variantXML4.testWriteXML(ICES_beans_variantSource4.variantBack(out, ICES_beans_variant4.getLog(), ICES_beans_trace4.printTraceTable1(out,ICES_beans_trace4.getLog()), 4));
%>
<%
    ICES_beans_variantMap4.writeXML("out/artifacts/hitpm_v2_war_exploded/Model1.js");
%>
