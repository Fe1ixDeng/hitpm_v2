...
public class InductiveMinerDialog extends JPanel {
	...
	public InductiveMinerDialog(XLog log) {
		...
		final ClassifierChooser classifiers;
		{
			...
			classifiers = new ClassifierChooser(log,getEventAttributes(log),false);
			//�������д
			add(classifiers);
...
//	public ClassifierChooser classifierChooser(XLog log, String[] eventAttributes, boolean filterLifeCycleTransition) {
