...
//    }
    public void writeXML(String path) throws IOException, ParseException {
      ...
      //  BpmnXMLConverter bpmnXMLConverter = new BpmnXMLConverter();
        ...
        String str2 = "`";
        String str3="src/hitpm_v2/ICES_beans_variant/testWrite.xml";
        FileInputStream fs = new FileInputStream(new File("/Users/silver-brick/Documents/ProcessMining/项目20220905/备份测试的项目/hitpm_v2/src/hitpm_v2/ICES_beans_variant/testWrite.xml"));
        byte[] b3 = IOUtils.toByteArray(fs);
       ...
       // byte[] b3 = bpmnXMLConverter.convertToXML(model);
        ...
        File webInfoDir = new File(WEB_INFO_DIRECTORY_PATH);
        String SERVLET_CONTEXT_PATH = String.valueOf(webInfoDir.getParent()) + "/";
        File file = new File("/Users/silver-brick/Documents/ProcessMining/项目20220905/备份测试的项目/hitpm_v2/out/artifacts/hitpm_v2_war_exploded/Model1.js");
        System.out.println("jkahsdkfhjsdllhjksdhfkjhk");
        if (file.exists())
            file.delete();
        if (!file.getParentFile().exists()) {
            boolean mkdir = file.getParentFile().mkdirs();
